...
<html lang="en">
<head>
    <title>Swift Express Logistics | Payment</title>
    ...
    <meta name="description" content="Swift Express Logistics Payment and Clearance">
    <meta name="keywords" content="Swift Express Logistics, payment, clearance, courier, crypto, bitcoin, ethereum, usdt">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium payment-status-paid">
                                            <i class="fas fa-check-circle mr-1"></i>
                                            Paid
                                        </span>
                                        <?php else: ?>
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium payment-status-pending">
                                            Pending
                                        </span>
                                        <?php endif; ?>
                                    </td>
                                ...
                                <tr class="bg-gray-50 font-semibold">
                                    ...
                                    <td class="text-pattern-primary text-lg">$<?=number_format($payment_details['total_amount'], 2)?></td>
                                    <td>
                                        <?php if ($payment_details['payment_status'] == 'PAID'): ?>
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium payment-status-paid">
                                            <i class="fas fa-check-circle mr-1"></i>
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium payment-status-failed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button @click="copyToClipboard('<?=$wallet_addresses['Bitcoin']['wallet_address']?>')" 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button @click="copyToClipboard('<?=$wallet_addresses['Ethereum']['wallet_address']?>')" 
                                                class="text-xs bg-gray-200 hover:bg-gray-300 text-gray-800 py-1 px-2 rounded">
                                            <i class="fas fa-copy mr-1"></i> Copy
                                        </button>
                                        <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button @click="copyToClipboard('<?=$wallet_addresses['USDT']['wallet_address']?>')" 
                                                class="text-xs bg-gray-200 hover:bg-gray-300 text-gray-800 py-1 px-2 rounded">
                                            <i class="fas fa-copy mr-1"></i> Copy
                                        </button>
                                        <?php endif; ?>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-1 text-sm text-blue-700">
                                    <p>Always send payments to the official wallet addresses listed above. Include your tracking number (<?=get_shipment_data('tracking_id');?>) in the payment memo/notes for proper credit.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border border-gray-200 rounded-b-lg p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="payment-card bg-white rounded-lg p-4 border border-gray-200 shadow-sm cursor-pointer" 
                            ...
                            <div class="flex items-center mb-3">
                                <div class="h-10 w-10 rounded-full bg-bitcoin flex items-center justify-center mr-3">
                        ...
                        <div class="payment-card bg-white rounded-lg p-4 border border-gray-200 shadow-sm cursor-pointer" 
                            ...
                            <div class="flex items-center mb-3">
                                <div class="h-10 w-10 rounded-full bg-ethereum flex items-center justify-center mr-3">
                        ...
                        <div class="payment-card bg-white rounded-lg p-4 border border-gray-200 shadow-sm cursor-pointer" 
                             :class="selectedMethod === 'usdt' ? 'selected' : ''"
                        ...
                        <!-- Bank Transfer -->
                        <div class="payment-card bg-white rounded-lg p-4 border border-gray-200 shadow-sm cursor-pointer" 
                             :class="selectedMethod === 'bank' ? 'selected' : ''"
                    ...
                    <div x-show="selectedMethod === 'bitcoin'" class="mt-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-1 text-sm text-orange-700">
                                        <p>Send the exact amount of Bitcoin to the address below. Payment will be confirmed after 3 network confirmations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 bg-gray-50 p-4 rounded-md">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-medium">$<?=number_format($payment_details['total_amount'], 2)?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">BTC Amount:</span>
                                        <span class="text-sm font-medium" x-text="calculateCryptoAmount('bitcoin')"></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">Exchange Rate:</span>
                                        <span class="text-sm font-medium">1 BTC = $<span x-text="cryptoRates.bitcoin"></span></span>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-2">
                                            <p class="text-xs text-amber-700">
                                                ...
                                                This payment address expires in <span class="countdown" x-text="formatTime(timeRemaining)"></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="crypto-qr text-center">
                                    ...
                                    <div class="flex justify-center mb-3">
                                        <div class="w-48 h-48 bg-white border border-gray-300 flex items-center justify-center">
                        ...
                        <div class="bg-gray-50 p-4 rounded-md">
                            ...
                            <ol class="text-xs text-gray-600 list-decimal list-inside space-y-1">
                                <li>Send exactly <span class="font-medium" x-text="calculateCryptoAmount('bitcoin')"></span> BTC to the address above</li>
                    ...
                    <div x-show="selectedMethod === 'ethereum'" class="mt-6">
                        <div class="bg-blue-50 p-4 rounded-md mb-6">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-1 text-sm text-blue-700">
                                        <p>Send the exact amount of Ethereum to the address below. Payment will be confirmed after 12 network confirmations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 bg-gray-50 p-4 rounded-md">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-medium" x-text="calculateCryptoAmount('ethereum')"></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">Exchange Rate:</span>
                                        <span class="text-sm font-medium">1 ETH = $<span x-text="cryptoRates.ethereum"></span></span>
                                    </div>
                                    <div class="flex justify-between">
                        ...
                        <div class="bg-gray-50 p-4 rounded-md">
                            <h4 class="text-sm font-medium text-gray-700 mb-2">Payment Instructions</h4>
                            <ol class="text-xs text-gray-600 list-decimal list-inside space-y-1">
                                <li>Send exactly <span class="font-medium" x-text="calculateCryptoAmount('ethereum')"></span> ETH to the address above</li>
                    ...
                    <div x-show="selectedMethod === 'usdt'" class="mt-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-1 text-sm text-green-700">
                                        <p>Send the exact amount of USDT to the address below. Payment will be confirmed after 12 network confirmations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 bg-gray-50 p-4 rounded-md">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-medium"><?=number_format($payment_details['total_amount'], 2)?> USDT</span>
                                    </div>
                                    <div class="flex justify-between">
                        ...
                        <div class="bg-gray-50 p-4 rounded-md">
                            <h4 class="text-sm font-medium text-gray-700 mb-2">Payment Instructions</h4>
                            <ol class="text-xs text-gray-600 list-decimal list-inside space-y-1">
                                <li>Send exactly <?=number_format($payment_details['total_amount'], 2)?> USDT to the address above</li>
                        ...
                        <div class="bg-gray-50 p-4 rounded-md mb-6">
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium text-pattern-primary">USD <?=number_format($payment_details['total_amount'], 2)?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Reference:</span>
                                    <span class="text-sm font-medium text-pattern-primary"><?=get_shipment_data('tracking_id');?></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-1 text-sm text-amber-700">
                                        <p>Please include your tracking number (<?=get_shipment_data('tracking_id');?>) as the payment reference. Your shipment will be released once we receive confirmation of your payment (1-3 business days).</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="space-y-2">
                                <p class="text-sm"><span class="font-medium">Name:</span> <?=get_shipment_data('sender_name')?></p>
                                <p class="text-sm"><span class="font-medium">Address:</span> <?=get_shipment_data('disperse_address')?>, <?=get_shipment_data('disperse_country')?></p>
                                <p class="text-sm"><span class="font-medium">Phone:</span> <?=get_shipment_data('sender_phone')?></p>
                            </div>
                        </div>
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-2">Receiver Details</h4>
                            <div class="space-y-2">
                                <p class="text-sm"><span class="font-medium">Name:</span> <?=get_shipment_data('reciever_name')?></p>
                                <p class="text-sm"><span class="font-medium">Address:</span> <?=get_shipment_data('delivering_to')?>, <?=get_shipment_data('delivering_country')?></p>
                                <p class="text-sm"><span class="font-medium">Phone:</span> <?=get_shipment_data('reciever_phone')?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <div class="bg-gray-100 p-2 rounded-md max-w-xs">
                            <img src="uploads/<?=get_shipment_data('photo')?>" 
                                 alt="Package Image" 
